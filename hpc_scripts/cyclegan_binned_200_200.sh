...
#SBATCH --job-name="cyclegan_binned_defaults"
...
python /home/bbltor001/pytorch-CycleGAN-and-pix2pix/train.py --display_id -1 --model cycle_gan --checkpoints_dir /scratch/bbltor001/checkpoints/ --dataroot /scratch/bbltor001/datasets/cityscapes-unal/ --name cyclegan_binned_defaults --save_epoch_freq 20 --n_epochs 200 --n_epochs_decay 200
