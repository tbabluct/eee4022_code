...
python /home/bbltor001/pytorch-CycleGAN-and-pix2pix/train.py --display_id -1 --model cycle_gan --checkpoints_dir /scratch/bbltor001/checkpoints --dataroot /home/bbltor001/datasets/georg-cyclegan/ --name georg_cyclegan_2 --save_epoch_freq 20
